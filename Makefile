...
ft_strdel.c ft_strdup.c ft_strequ.c ft_striter.c ft_striteri.c ft_strlcat.c ft_strlen.c \
...
ft_toupper.c ft_strjoin.c get_next_line.c ft_atoi_base.c ft_realloc.c ft_double_free.c
